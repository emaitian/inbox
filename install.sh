...
~/.acme.sh/acme.sh --set-default-ca --server letsencrypt --issue -d eiven.cfd --nginx /etc/nginx/nginx.conf
mkdir -p /home/cert
~/.acme.sh/acme.sh --install-cert -d eiven.cfd --fullchain-file /home/cert/fullchain.crt
~/.acme.sh/acme.sh --install-cert -d eiven.cfd --key-file /home/cert/eiven.cfd.key
chmod +r /home/cert/eiven.cfd.key
echo
